...
const footer = () => {
  return (
    <div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-12">
        <div>
          ...
          <ul class="space-y-5">
            ...
            <li><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Contact</a></li>
        ...
        <div>
          ...
          <ul class="space-y-5">
            <li><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Privacy Policy</a></li>
            <li><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Terms of Service</a></li>
            <li><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Refund Policy</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-5">
            ...
            <li><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Shipping Information</a></li>
            <li><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Returns & Exchanges</a></li>
          </ul>
        </div>

        <div class="col-span-full max-w-2xl">
          <h4 class="text-white text-lg font-semibold mb-6">Newsletter</h4>
          <p class="text-gray-300 mb-4 text-[15px]">Subscribe to our newsletter to get updates on new products and promotions.
          </p>
      ...
      <p class='text-gray-300 text-right text-[15px] mt-8'>© ReadymadeUI. All rights reserved.
      </p>
    </footer>
    </div>
  )
