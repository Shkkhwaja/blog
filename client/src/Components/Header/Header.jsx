    ...
    <div class='flex flex-wrap items-center justify-between gap-4 w-full'>
      <Link href="/"
        class="lg:absolute max-lg:left-10 lg:top-2/4 lg:left-2/4 lg:-translate-x-1/2 lg:-translate-y-1/2">
            <Image src={logo} alt="logo" class='w-36' />
      </Link>
      ...
      <div class='flex items-center ml-auto space-x-6'>
        <button class='font-semibold text-[15px] border-none outline-none'><Link href='/auth/login'
            class='text-[#007bff] hover:underline'>Login</Link></button>
        <button
          class='px-4 py-2 text-sm rounded-sm font-bold text-white border-2 border-[#007bff] bg-[#007bff] transition-all ease-in-out duration-300 hover:bg-transparent hover:text-[#007bff]'><Link href="/auth/register">Sign
          up</Link></button>
